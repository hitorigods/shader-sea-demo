...
gui.add(material.uniforms.uFrequency.value, 'x').min(0).max(10).step(0.001).name('uFrequency x');
gui.add(material.uniforms.uFrequency.value, 'y').min(0).max(10).step(0.001).name('uFrequency y');
...
gui.add(material.uniforms.uSmallWaveFrequency, 'value').min(0).max(5).step(0.001).name('uSmallWaveFrequency');
